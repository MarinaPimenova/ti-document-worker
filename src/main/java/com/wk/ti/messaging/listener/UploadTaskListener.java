package com.wk.ti.messaging.listener;

import com.wk.ti.etl.extract.ETLPipelineResolver;
import com.wk.ti.messaging.event.FileProcessingEvent;
import com.wk.ti.messaging.event.UploadCompletedEvent;
import com.wk.ti.messaging.event.UploadFailedEvent;
...
public class UploadTaskListener {
    ...
    public void processUpload(FileProcessingEvent event) {
        ...
        try {
            ...
            etlPipelineResolver.process(rawFile, event.originalFilename());
